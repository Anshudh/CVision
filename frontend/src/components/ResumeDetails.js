      ...
      <section className="details-section">
        ...
        <div className="info-grid">
          ...
          <div className="info-item">
            ...
            {resume.linkedin_url ? (
              <a href={normalizeUrl(resume.linkedin_url)} target="_blank" rel="noopener noreferrer">
                View Profile
              </a>
            ) : (
              ' Not found'
          ...
          {resume.portfolio_url && (
            <div className="info-item">
              ...
              <a href={normalizeUrl(resume.portfolio_url)} target="_blank" rel="noopener noreferrer">
                View Portfolio
              </a>
            </div>
          )}
